...
Decay_Ap = Decay(name = 'Decay_Ap',
                 particle = P.Ap,
                 partial_widths = {(P.b,P.b__tilde__):'(((4*ee**2*eps**2*MAp**2)/3. + (8*ee**2*eps**2*MB**2)/3.)*cmath.sqrt(MAp**4 - 4*MAp**2*MB**2))/(48.*cmath.pi*abs(MAp)**3)',
                                   (P.c,P.c__tilde__):'(ee**2*eps**2*MAp**4)/(9.*cmath.pi*abs(MAp)**3)',
                                   (P.d,P.d__tilde__):'(ee**2*eps**2*MAp**4)/(36.*cmath.pi*abs(MAp)**3)',
                                   (P.e__minus__,P.e__plus__):'(ee**2*eps**2*MAp**4)/(12.*cmath.pi*abs(MAp)**3)',
                                   (P.mu__minus__,P.mu__plus__):'(ee**2*eps**2*MAp**4)/(12.*cmath.pi*abs(MAp)**3)',
                                   (P.s,P.s__tilde__):'(ee**2*eps**2*MAp**4)/(36.*cmath.pi*abs(MAp)**3)',
                                   (P.ta__minus__,P.ta__plus__):'((4*ee**2*eps**2*MAp**2 + 8*ee**2*eps**2*MTA**2)*cmath.sqrt(MAp**4 - 4*MAp**2*MTA**2))/(48.*cmath.pi*abs(MAp)**3)',
                                   (P.t,P.t__tilde__):'(((16*ee**2*eps**2*MAp**2)/3. + (32*ee**2*eps**2*MT**2)/3.)*cmath.sqrt(MAp**4 - 4*MAp**2*MT**2))/(48.*cmath.pi*abs(MAp)**3)',
                                   (P.u,P.u__tilde__):'(ee**2*eps**2*MAp**4)/(9.*cmath.pi*abs(MAp)**3)'})
